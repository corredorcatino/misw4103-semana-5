...
const reference = "../kraken/screenshots/v5.0.0";
const test = "../kraken/screenshots/v5.68.0";
const compareConfigFilename = path.join(process.cwd(), "krakenCompareConfig.json");
